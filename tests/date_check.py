...
def fill_and_submit_form(page, start_year, end_year, scenario_name, expect_error=False):
    # Open form
...
def test_full_flow():
    ...
    with sync_playwright() as p:
        ...
        # Scenario 3: Start > End (expect error popup)
        fill_and_submit_form(page, 2025, 2020, "scenario3_start_higher", expect_error=True)
